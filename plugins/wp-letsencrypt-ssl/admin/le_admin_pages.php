...
class WPLE_SubAdmin extends WPLE_Admin_Page
{
    ...
    private function wple_ssl_score()
    {
        ...
        $featurelist .= '<li><strong>Recommended:</strong> Run Insecure content scanner & make sure no issue exists (<a href="/wp-admin/admin.php?page=wp_encryption_mixed_scanner">Scan now</a>)</li>';
        //5.7.0
        $plugin = false;
